...
import 'package:myanmar_calendar_dart_cli/src/command_runner.dart';
...
void main() {
  group('MyanmarCalendarDartCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late MyanmarCalendarDartCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = MyanmarCalendarDartCliCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = MyanmarCalendarDartCliCommandRunner();
